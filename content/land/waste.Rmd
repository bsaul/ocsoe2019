...
title: "Waste"
tags: ["Land Resources"]
summary: Orange County excels at recycling. Still, citizens and county leaders have many opportunities to reduce waste.
---
...
The following interactive graphic shows tonnage of Municipal Solid Waste + Construction and Demoltion Waste and Recycling for all NC counties according to 2016-17 NC DEQ annual report. In this year, Orange County reported `r round(oc_waste_tons_pp, 2)` tons of waste per person and `r round(oc_recyc_tons_pp, 2)` tons of reycling per person. Recycling accounted for `r round(oc$prop_recycling, 2)*100`% of all reported waste and recycling. 
